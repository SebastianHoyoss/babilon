...
def mostrar_productos():
    ...
    ventana_mostrar_productos.after(1000, lambda: mostrar_productos())  # Actualiza la lista cada segundo
...
if __name__ == "__main__":
    ...
    boton_producto = tk.Button(frame1, text="Crear Producto", command=abrir_ventana_producto)
    boton_mostrar_productos = tk.Button(frame1, text="Mostrar Productos", command=abrir_func2)
    boton_eliminar_producto = tk.Button(frame1, text="Eliminar Producto", command=abrir_func3)
    boton_salir = tk.Button(frame1, text="Salir", command=salir)

    etiqueta.grid(row=0, column=0, padx=0, pady=10, sticky="nsew")
    boton_producto.grid(row=1, column=0, padx=0, pady=10, sticky="nsew")
    boton_mostrar_productos.grid(row=2, column=0, padx=0, pady=10, sticky="nsew")
    boton_eliminar_producto.grid(row=3, column=0, padx=0, pady=10, sticky="nsew")
